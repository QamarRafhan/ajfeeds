                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('roles.store') }}">
                        ...
                        <div class="mb-6">
                            ...
                            <x-text-input id="name" name="name" type="text" class="mt-1 block w-full" :value="old('name')" required autofocus placeholder="e.g., Manager, Accountant" />
                        ...
                        <div class="mb-6">
                            ...
                            @if($permissions->isEmpty())
                                <p class="text-sm text-gray-500 italic">No permissions defined in the system yet. You can create the role now and assign permissions later via code or seeders.</p>
                            @else
