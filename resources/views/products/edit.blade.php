                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="mb-4">
                                    ...
                                    @if($product->image)
                                        <div class="mt-2">
                                            <img src="{{ Storage::url($product->image) }}" class="w-16 h-16 object-cover rounded" alt="Image">
                                        </div>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div>
                                <div class="mb-4">
                                    ...
                                    <x-text-input id="purchase_price" class="block mt-1 w-full" type="number" step="0.01" name="purchase_price" :value="old('purchase_price', $product->purchase_price)" required />
                                ...
                                <div class="mb-4">
                                    ...
                                    <x-text-input id="stock_quantity" class="block mt-1 w-full bg-gray-50 text-gray-500" type="number" name="stock_quantity" :value="old('stock_quantity', $product->stock_quantity)" />
                                    <x-input-error :messages="$errors->get('stock_quantity')" class="mt-2" />
                                </div>

                                <div class="mb-4">
                                    <x-input-label for="min_stock_alert" :value="__('Min Stock Alert')" />
                                    <x-text-input id="min_stock_alert" class="block mt-1 w-full" type="number" name="min_stock_alert" :value="old('min_stock_alert', $product->min_stock_alert)" required />
