<aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" class="absolute z-40 flex flex-col w-64 h-screen transition-transform duration-300 ease-in-out lg:static lg:translate-x-0 bg-sidebar border-r border-sidebar-border shadow-xl">
    ...
    <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
        <a href="{{ route('dashboard') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg font-medium transition {{ request()->routeIs('dashboard') ? 'bg-indigo-600 text-white shadow' : 'text-muted hover:bg-indigo-50 hover:text-indigo-700' }}">
        ...
        <a href="{{ route('categories.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg font-medium transition {{ request()->routeIs('categories.*') ? 'bg-indigo-600 text-white shadow' : 'text-muted hover:bg-indigo-50 hover:text-indigo-700' }}">
        ...
        <a href="{{ route('products.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg font-medium transition {{ request()->routeIs('products.*') ? 'bg-indigo-600 text-white shadow' : 'text-muted hover:bg-indigo-50 hover:text-indigo-700' }}">
        ...
        <a href="{{ route('suppliers.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg font-medium transition {{ request()->routeIs('suppliers.*') ? 'bg-indigo-600 text-white shadow' : 'text-muted hover:bg-indigo-50 hover:text-indigo-700' }}">
        ...
        <a href="{{ route('purchases.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg font-medium transition {{ request()->routeIs('purchases.*') ? 'bg-indigo-600 text-white shadow' : 'text-muted hover:bg-indigo-50 hover:text-indigo-700' }}">
        ...
        <a href="{{ route('orders.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg font-medium transition {{ request()->routeIs('orders.*') ? 'bg-indigo-600 text-white shadow' : 'text-muted hover:bg-indigo-50 hover:text-indigo-700' }}">
        ...
        @role('Admin')
        <a href="{{ route('users.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg font-medium transition {{ request()->routeIs('users.*') ? 'bg-indigo-600 text-white shadow' : 'text-muted hover:bg-indigo-50 hover:text-indigo-700' }}">
            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
            Staff Accounts
        </a>
        <a href="{{ route('roles.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg font-medium transition {{ request()->routeIs('roles.*') ? 'bg-indigo-600 text-white shadow' : 'text-muted hover:bg-indigo-50 hover:text-indigo-700' }}">
            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
            Roles & Permissions
        </a>
        <a href="{{ route('permissions.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg font-medium transition {{ request()->routeIs('permissions.*') ? 'bg-indigo-600 text-white shadow' : 'text-muted hover:bg-indigo-50 hover:text-indigo-700' }}">
